    ...
    <div className="bg-white dark:bg-slate-900 rounded-md border border-gray-200 dark:border-slate-800 p-3 space-y-3 shadow-2xs text-xs text-gray-900 dark:text-slate-100">
      ...
      <div className="flex items-center justify-between pb-2 border-b border-gray-100 dark:border-slate-800">
        <div className="font-bold text-gray-900 dark:text-slate-100 text-xs flex items-center gap-1.5">
          <Navigation className="w-4 h-4 text-blue-600 dark:text-blue-400 shrink-0" /> AI Dynamic Route Optimizer
        </div>
        <span className="text-[10px] text-gray-500 dark:text-slate-400 font-mono">Live Predictive Engine</span>
      </div>

      {/* Input Controls */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
        <div>
          <label className="text-[10px] text-gray-500 dark:text-slate-400 font-semibold block mb-1">Origin / Source Point</label>
          <input
            type="text"
            value={source}
            onChange={(e) => setSource(e.target.value)}
            className="w-full bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded px-2.5 py-1.5 text-xs text-gray-900 dark:text-slate-100 font-medium focus:outline-none focus:border-blue-500 dark:focus:border-blue-400"
          />
        </div>

        <div>
          <label className="text-[10px] text-gray-500 dark:text-slate-400 font-semibold block mb-1">Destination Target</label>
          <input
            type="text"
            value={destination}
      ...
      <div className="space-y-1">
        <label className="text-[10px] text-gray-500 dark:text-slate-400 font-semibold block">Routing Priority Objective</label>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5">
          ...
          >
            <Zap className="w-3 h-3 shrink-0" /> Min Congestion
          </button>
          ...
          >
            <Clock className="w-3 h-3 shrink-0" /> Fastest ETA
          </button>
          ...
          >
            <ShieldCheck className="w-3 h-3 shrink-0" /> Safest Flow
          </button>
          ...
          >
            <Bus className="w-3 h-3 shrink-0" /> Public Transit
          </button>
        </div>
      </div>
      ...
      {/* Result Card */}
      {isCalculated && (
        <div className="bg-slate-900 dark:bg-slate-950 text-slate-100 p-3 rounded-md space-y-2.5 border border-slate-800 shadow-2xs">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between pb-1.5 border-b border-slate-800 gap-1">
            <span className="font-bold text-xs text-blue-400 flex items-center gap-1.5">
              <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400 shrink-0" /> Optimal Route Computed
            </span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-[11px]">
            <div className="bg-slate-800/80 dark:bg-slate-900/80 p-2 rounded border border-slate-700">
          ...
          <div className="text-[11px] text-slate-300 space-y-1">
            <div className="font-semibold text-slate-200 flex items-center gap-1">
              <ArrowRight className="w-3 h-3 text-blue-400 shrink-0" /> Recommended Alternate Bypass:
            </div>
            <p className="text-[10px] text-slate-400 leading-relaxed bg-slate-800/40 dark:bg-slate-900/40 p-2 rounded border border-slate-800">
