    ...
    <div className="flex-1 flex flex-col h-full overflow-y-auto p-3 sm:p-4 space-y-3 sm:space-y-4 bg-[#F4F6F8] text-xs">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-2.5">
        ...
        <div className="bg-white p-2.5 rounded-md border border-gray-200 shadow-2xs space-y-1">
          ...
          <div className="text-[9px] font-semibold text-amber-800">Zhongxiao / Jianguo Elevated</div>
              ...
              <div className="bg-white rounded-md border border-gray-200 p-3 space-y-3 shadow-2xs h-full">
                ...
                <div className="bg-slate-900 text-slate-100 p-3 rounded-md space-y-2 border border-slate-800">
                  ...
                  <p className="text-[11px] text-slate-200 leading-relaxed font-sans">
                    Traffic congestion is increasing along Jianguo Elevated Rd and Zhongxiao E. Rd due to evening commuter demand. Recommend increasing green signal duration by 20 seconds at Dunhua and Minsheng junctions.
                  </p>
                </div>
                  ...
                  <div className="space-y-2">
                    <div className="bg-gray-50 p-2.5 rounded border border-gray-200 space-y-1.5">
                      ...
                      <p className="text-[10px] text-gray-600">
                        Extends green light phase across Jianguo Elevated Rd Northbound corridors to alleviate exit queue buildup.
                      </p>
                      <button
                        onClick={triggerQuickSignalOptimization}
                    ...
                    <div className="bg-gray-50 p-2.5 rounded border border-gray-200 space-y-1.5">
                      ...
                      <p className="text-[10px] text-gray-600">
                        Display alternate route guidance via Huanhe Expressway on overhead electronic signboards.
                      </p>
                      <button
